...
@section('admin')
    ...
    <div style="margin-left: 30px; margin-top: 25px; margin-right: 450px;">
        <form method="post" action="{{ route('admin.category.update') }}">
            ...
            <h3 style="margin-bottom: 15px;">Modifier une catégorie</h3>

            <input type="hidden" value="{{ $id }}" name="id">

            <div class="form-group">
                <label class="info-title" for="category_name_fr">Nom Français</label>
                <input type="text" name="category_name_fr" value="{{ $old_category->category_name_fr }}" class="form-control unicase-form-control text-input" autofocus>
            ...
            <div class="form-group">
                ...
                <input type="text" name="category_name_en" value="{{ $old_category->category_name_en }}" class="form-control unicase-form-control text-input">
