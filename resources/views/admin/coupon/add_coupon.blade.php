...
@section('admin')
    ...
    <div style="margin-left: 30px; margin-top: 25px; margin-right: 450px;">
        <form method="post" action="{{ route('admin.coupon.store') }}">
            ...
            <h3 style="margin-bottom: 15px;">Ajouter un coupon</h3>
            ...
            <button type="submit" class="btn-upper btn btn-primary btn-md checkout-page-button">Ajouter le coupon</button>
        </form>
    </div>
