  ...
  <div class='container'>
    <div class='row'>
      <div class='col-md-3 sidebar'> 
        ...
        <!-- /.side-menu --> 
        <!-- ================================== TOP NAVIGATION : END ================================== -->
        <div class="sidebar-module-container" style="margin-bottom: 20px;">
          <div class="sidebar-filter"> 
            ...
            <div class="sidebar-widget wow fadeInUp">
              <div class="widget-header">
                <h4 class="widget-title">Prix minimum et maximum</h4>
              </div>
              <div class="sidebar-widget-body m-t-10">
                <form method="post" action="{{ route('product.price.range') }}">
                  @csrf
                  <div class="price-range-holder"> <span class="min-max"> </span>
                    <input type="hidden" name="search" value="{{ $search }}">
                    <input type="text" id="amount" style="border:0; color:#666666; font-weight:bold;text-align:center;">
                    <input type="text" name="price_range" class="price-slider">
                  </div>
                  <!-- /.price-range-holder --> 
