...
<h3 style="background-color: rgb(21, 126, 210); padding: 10px; display: inline-block; color: white; margin-top: -5px; margin-bottom: 10px;">Modifier mon mot de passe</h3>
    <form method="post" action="{{ route('user.password.update') }}">
        ...
        <button type="submit" class="btn btn-info" style="margin-top: 20px; background-color: rgb(21, 126, 210)!important; border: none;">Enregistrer les modifications</button>
    </form>
</div>
